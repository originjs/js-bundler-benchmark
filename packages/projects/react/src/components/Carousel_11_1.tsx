...
const slides: SlideData[] = [
   {content: '#4AEAC1', backgroundColor: '#4AEAC1'},{content: '#9D8728', backgroundColor: '#9D8728'},{content: '#2159A6', backgroundColor: '#2159A6'},
];
interface Styles {
