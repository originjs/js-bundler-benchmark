...
const slides: SlideData[] = [
   {content: '#249CCC', backgroundColor: '#249CCC'},{content: '#DA47BD', backgroundColor: '#DA47BD'},{content: '#14E64A', backgroundColor: '#14E64A'},
];
interface Styles {
