...
const slides: SlideData[] = [
   {content: '#5C9ED6', backgroundColor: '#5C9ED6'},{content: '#C7C505', backgroundColor: '#C7C505'},{content: '#67FDDF', backgroundColor: '#67FDDF'},
];
interface Styles {
