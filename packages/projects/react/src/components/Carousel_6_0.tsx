...
const slides: SlideData[] = [
   {content: '#E09D3F', backgroundColor: '#E09D3F'},{content: '#EA0141', backgroundColor: '#EA0141'},{content: '#ECFE88', backgroundColor: '#ECFE88'},
];
interface Styles {
