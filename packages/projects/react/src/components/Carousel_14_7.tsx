...
const slides: SlideData[] = [
   {content: '#F3B107', backgroundColor: '#F3B107'},{content: '#9CAA36', backgroundColor: '#9CAA36'},{content: '#54133F', backgroundColor: '#54133F'},
];
interface Styles {
