...
const slides: SlideData[] = [
   {content: '#0DACA4', backgroundColor: '#0DACA4'},{content: '#47C80D', backgroundColor: '#47C80D'},{content: '#1A4472', backgroundColor: '#1A4472'},
];
interface Styles {
