...
const slides: SlideData[] = [
   {content: '#9EE2D7', backgroundColor: '#9EE2D7'},{content: '#61CE1B', backgroundColor: '#61CE1B'},{content: '#2C0ABE', backgroundColor: '#2C0ABE'},
];
interface Styles {
