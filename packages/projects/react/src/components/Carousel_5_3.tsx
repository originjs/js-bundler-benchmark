...
const slides: SlideData[] = [
   {content: '#D3201A', backgroundColor: '#D3201A'},{content: '#92EBAE', backgroundColor: '#92EBAE'},{content: '#7AC6E9', backgroundColor: '#7AC6E9'},
];
interface Styles {
