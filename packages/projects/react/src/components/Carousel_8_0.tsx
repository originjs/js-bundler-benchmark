...
const slides: SlideData[] = [
   {content: '#B67ED0', backgroundColor: '#B67ED0'},{content: '#A587CE', backgroundColor: '#A587CE'},{content: '#2774B3', backgroundColor: '#2774B3'},
];
interface Styles {
