...
const slides: SlideData[] = [
   {content: '#B51C88', backgroundColor: '#B51C88'},{content: '#94A623', backgroundColor: '#94A623'},{content: '#55C98C', backgroundColor: '#55C98C'},
];
interface Styles {
