...
const slides: SlideData[] = [
   {content: '#8D8FC9', backgroundColor: '#8D8FC9'},{content: '#DAB03F', backgroundColor: '#DAB03F'},{content: '#2CB097', backgroundColor: '#2CB097'},
];
interface Styles {
