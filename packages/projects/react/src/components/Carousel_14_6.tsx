...
const slides: SlideData[] = [
   {content: '#AB81CD', backgroundColor: '#AB81CD'},{content: '#DC06AE', backgroundColor: '#DC06AE'},{content: '#85D1EB', backgroundColor: '#85D1EB'},
];
interface Styles {
