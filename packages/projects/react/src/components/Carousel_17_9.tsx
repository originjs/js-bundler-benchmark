...
const slides: SlideData[] = [
   {content: '#E6A54C', backgroundColor: '#E6A54C'},{content: '#775F61', backgroundColor: '#775F61'},{content: '#FE8EB2', backgroundColor: '#FE8EB2'},
];
interface Styles {
