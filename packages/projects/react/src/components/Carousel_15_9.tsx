...
const slides: SlideData[] = [
   {content: '#00A2E2', backgroundColor: '#00A2E2'},{content: '#E402E6', backgroundColor: '#E402E6'},{content: '#BBBAC7', backgroundColor: '#BBBAC7'},
];
interface Styles {
