...
const slides: SlideData[] = [
   {content: '#6DBE32', backgroundColor: '#6DBE32'},{content: '#837E07', backgroundColor: '#837E07'},{content: '#87AC03', backgroundColor: '#87AC03'},
];
interface Styles {
