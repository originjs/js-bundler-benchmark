...
const slides: SlideData[] = [
   {content: '#E9CF00', backgroundColor: '#E9CF00'},{content: '#5E0A10', backgroundColor: '#5E0A10'},{content: '#2A674B', backgroundColor: '#2A674B'},
];
interface Styles {
