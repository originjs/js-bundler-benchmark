...
const slides: SlideData[] = [
   {content: '#C4F4B3', backgroundColor: '#C4F4B3'},{content: '#9FBBD2', backgroundColor: '#9FBBD2'},{content: '#54E6C6', backgroundColor: '#54E6C6'},
];
interface Styles {
