...
const slides: SlideData[] = [
   {content: '#80420B', backgroundColor: '#80420B'},{content: '#5CE6EB', backgroundColor: '#5CE6EB'},{content: '#DC8D4A', backgroundColor: '#DC8D4A'},
];
interface Styles {
