...
const slides: SlideData[] = [
   {content: '#A06366', backgroundColor: '#A06366'},{content: '#28712E', backgroundColor: '#28712E'},{content: '#9410B3', backgroundColor: '#9410B3'},
];
interface Styles {
