...
const slides: SlideData[] = [
   {content: '#E0351A', backgroundColor: '#E0351A'},{content: '#DEAC79', backgroundColor: '#DEAC79'},{content: '#6B13AF', backgroundColor: '#6B13AF'},
];
interface Styles {
