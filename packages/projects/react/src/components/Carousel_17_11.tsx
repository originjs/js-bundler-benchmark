...
const slides: SlideData[] = [
   {content: '#AA445C', backgroundColor: '#AA445C'},{content: '#6323C9', backgroundColor: '#6323C9'},{content: '#E708F9', backgroundColor: '#E708F9'},
];
interface Styles {
