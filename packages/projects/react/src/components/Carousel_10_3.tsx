...
const slides: SlideData[] = [
   {content: '#C65AD0', backgroundColor: '#C65AD0'},{content: '#A6327F', backgroundColor: '#A6327F'},{content: '#6A7D0A', backgroundColor: '#6A7D0A'},
];
interface Styles {
