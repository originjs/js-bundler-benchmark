...
const slides: SlideData[] = [
   {content: '#E3BE58', backgroundColor: '#E3BE58'},{content: '#47DB45', backgroundColor: '#47DB45'},{content: '#5A4105', backgroundColor: '#5A4105'},
];
interface Styles {
