...
const slides: SlideData[] = [
   {content: '#130FB0', backgroundColor: '#130FB0'},{content: '#5E0B2C', backgroundColor: '#5E0B2C'},{content: '#7DF4A8', backgroundColor: '#7DF4A8'},
];
interface Styles {
