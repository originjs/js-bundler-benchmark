...
const slides: SlideData[] = [
   {content: '#64A212', backgroundColor: '#64A212'},{content: '#F801DF', backgroundColor: '#F801DF'},{content: '#425211', backgroundColor: '#425211'},
];
interface Styles {
