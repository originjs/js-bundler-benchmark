...
const slides: SlideData[] = [
   {content: '#A7F67A', backgroundColor: '#A7F67A'},{content: '#046935', backgroundColor: '#046935'},{content: '#9DA938', backgroundColor: '#9DA938'},
];
interface Styles {
