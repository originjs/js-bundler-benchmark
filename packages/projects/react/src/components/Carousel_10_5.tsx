...
const slides: SlideData[] = [
   {content: '#4A134C', backgroundColor: '#4A134C'},{content: '#056704', backgroundColor: '#056704'},{content: '#474B75', backgroundColor: '#474B75'},
];
interface Styles {
