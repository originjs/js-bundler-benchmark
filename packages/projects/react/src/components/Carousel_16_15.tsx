...
const slides: SlideData[] = [
   {content: '#BFC45A', backgroundColor: '#BFC45A'},{content: '#8052E7', backgroundColor: '#8052E7'},{content: '#845FD2', backgroundColor: '#845FD2'},
];
interface Styles {
