...
const slides: SlideData[] = [
   {content: '#0BEE49', backgroundColor: '#0BEE49'},{content: '#20EA82', backgroundColor: '#20EA82'},{content: '#84666A', backgroundColor: '#84666A'},
];
interface Styles {
