...
const slides: SlideData[] = [
   {content: '#B4C51C', backgroundColor: '#B4C51C'},{content: '#7123BB', backgroundColor: '#7123BB'},{content: '#64B4B1', backgroundColor: '#64B4B1'},
];
interface Styles {
