...
const slides: SlideData[] = [
   {content: '#1AAB6D', backgroundColor: '#1AAB6D'},{content: '#ED5F16', backgroundColor: '#ED5F16'},{content: '#B1658B', backgroundColor: '#B1658B'},
];
interface Styles {
