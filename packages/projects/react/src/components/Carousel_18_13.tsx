...
const slides: SlideData[] = [
   {content: '#620609', backgroundColor: '#620609'},{content: '#4CD9CC', backgroundColor: '#4CD9CC'},{content: '#CD0178', backgroundColor: '#CD0178'},
];
interface Styles {
