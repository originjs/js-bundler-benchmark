...
const slides: SlideData[] = [
   {content: '#CA2E62', backgroundColor: '#CA2E62'},{content: '#82CCAB', backgroundColor: '#82CCAB'},{content: '#93F866', backgroundColor: '#93F866'},
];
interface Styles {
