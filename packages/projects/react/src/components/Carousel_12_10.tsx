...
const slides: SlideData[] = [
   {content: '#AAC0AF', backgroundColor: '#AAC0AF'},{content: '#F3A768', backgroundColor: '#F3A768'},{content: '#C56AA3', backgroundColor: '#C56AA3'},
];
interface Styles {
