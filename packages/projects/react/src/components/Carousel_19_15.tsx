...
const slides: SlideData[] = [
   {content: '#7D18D5', backgroundColor: '#7D18D5'},{content: '#AC5C23', backgroundColor: '#AC5C23'},{content: '#323BAE', backgroundColor: '#323BAE'},
];
interface Styles {
