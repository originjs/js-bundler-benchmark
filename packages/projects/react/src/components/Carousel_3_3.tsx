...
const slides: SlideData[] = [
   {content: '#BD9101', backgroundColor: '#BD9101'},{content: '#DF8334', backgroundColor: '#DF8334'},{content: '#4E4218', backgroundColor: '#4E4218'},
];
interface Styles {
