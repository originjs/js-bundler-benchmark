...
const slides: SlideData[] = [
   {content: '#02DEE0', backgroundColor: '#02DEE0'},{content: '#4DFF67', backgroundColor: '#4DFF67'},{content: '#590475', backgroundColor: '#590475'},
];
interface Styles {
