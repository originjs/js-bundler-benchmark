...
const slides: SlideData[] = [
   {content: '#2435DE', backgroundColor: '#2435DE'},{content: '#A0F4DF', backgroundColor: '#A0F4DF'},{content: '#5AA444', backgroundColor: '#5AA444'},
];
interface Styles {
