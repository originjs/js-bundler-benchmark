...
const slides: SlideData[] = [
   {content: '#71FF20', backgroundColor: '#71FF20'},{content: '#73AD36', backgroundColor: '#73AD36'},{content: '#8FB992', backgroundColor: '#8FB992'},
];
interface Styles {
