...
const slides: SlideData[] = [
   {content: '#4CD4E9', backgroundColor: '#4CD4E9'},{content: '#72C953', backgroundColor: '#72C953'},{content: '#04EE43', backgroundColor: '#04EE43'},
];
interface Styles {
