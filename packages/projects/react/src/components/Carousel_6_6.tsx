...
const slides: SlideData[] = [
   {content: '#A5580E', backgroundColor: '#A5580E'},{content: '#26A0DA', backgroundColor: '#26A0DA'},{content: '#92B442', backgroundColor: '#92B442'},
];
interface Styles {
