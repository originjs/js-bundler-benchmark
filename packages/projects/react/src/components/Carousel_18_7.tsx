...
const slides: SlideData[] = [
   {content: '#B5A1B1', backgroundColor: '#B5A1B1'},{content: '#A836F9', backgroundColor: '#A836F9'},{content: '#AEC8D3', backgroundColor: '#AEC8D3'},
];
interface Styles {
