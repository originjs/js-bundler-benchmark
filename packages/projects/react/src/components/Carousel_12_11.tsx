...
const slides: SlideData[] = [
   {content: '#52EA20', backgroundColor: '#52EA20'},{content: '#8EBC38', backgroundColor: '#8EBC38'},{content: '#38ADF9', backgroundColor: '#38ADF9'},
];
interface Styles {
