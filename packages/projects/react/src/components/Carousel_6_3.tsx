...
const slides: SlideData[] = [
   {content: '#A50294', backgroundColor: '#A50294'},{content: '#B9DD20', backgroundColor: '#B9DD20'},{content: '#E5380B', backgroundColor: '#E5380B'},
];
interface Styles {
