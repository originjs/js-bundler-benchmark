...
const slides: SlideData[] = [
   {content: '#0F5FFD', backgroundColor: '#0F5FFD'},{content: '#D70C66', backgroundColor: '#D70C66'},{content: '#6890DF', backgroundColor: '#6890DF'},
];
interface Styles {
