...
const slides: SlideData[] = [
   {content: '#136476', backgroundColor: '#136476'},{content: '#F4E12E', backgroundColor: '#F4E12E'},{content: '#1F16F5', backgroundColor: '#1F16F5'},
];
interface Styles {
