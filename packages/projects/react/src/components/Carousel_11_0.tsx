...
const slides: SlideData[] = [
   {content: '#7BD259', backgroundColor: '#7BD259'},{content: '#7BC358', backgroundColor: '#7BC358'},{content: '#4C0947', backgroundColor: '#4C0947'},
];
interface Styles {
