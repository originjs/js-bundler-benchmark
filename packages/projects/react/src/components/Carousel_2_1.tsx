...
const slides: SlideData[] = [
   {content: '#6A63AF', backgroundColor: '#6A63AF'},{content: '#88F0D9', backgroundColor: '#88F0D9'},{content: '#D7769F', backgroundColor: '#D7769F'},
];
interface Styles {
