...
const slides: SlideData[] = [
   {content: '#C5A741', backgroundColor: '#C5A741'},{content: '#D95365', backgroundColor: '#D95365'},{content: '#59CD7E', backgroundColor: '#59CD7E'},
];
interface Styles {
