...
const slides: SlideData[] = [
   {content: '#99CDC0', backgroundColor: '#99CDC0'},{content: '#AFAFE6', backgroundColor: '#AFAFE6'},{content: '#13A3CA', backgroundColor: '#13A3CA'},
];
interface Styles {
