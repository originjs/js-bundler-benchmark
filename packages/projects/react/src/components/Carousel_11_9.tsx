...
const slides: SlideData[] = [
   {content: '#2A1224', backgroundColor: '#2A1224'},{content: '#E51B7A', backgroundColor: '#E51B7A'},{content: '#7A2AAF', backgroundColor: '#7A2AAF'},
];
interface Styles {
