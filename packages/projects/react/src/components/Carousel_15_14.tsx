...
const slides: SlideData[] = [
   {content: '#8B3266', backgroundColor: '#8B3266'},{content: '#139E74', backgroundColor: '#139E74'},{content: '#0AB214', backgroundColor: '#0AB214'},
];
interface Styles {
