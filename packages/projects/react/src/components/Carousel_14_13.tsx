...
const slides: SlideData[] = [
   {content: '#34581E', backgroundColor: '#34581E'},{content: '#E45D47', backgroundColor: '#E45D47'},{content: '#D2F2F2', backgroundColor: '#D2F2F2'},
];
interface Styles {
