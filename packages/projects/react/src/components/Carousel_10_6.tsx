...
const slides: SlideData[] = [
   {content: '#D4DF18', backgroundColor: '#D4DF18'},{content: '#CFAB21', backgroundColor: '#CFAB21'},{content: '#28E907', backgroundColor: '#28E907'},
];
interface Styles {
