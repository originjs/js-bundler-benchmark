...
const slides: SlideData[] = [
   {content: '#6DDF7B', backgroundColor: '#6DDF7B'},{content: '#5D4B21', backgroundColor: '#5D4B21'},{content: '#3D3702', backgroundColor: '#3D3702'},
];
interface Styles {
