...
const slides: SlideData[] = [
   {content: '#0ABB4F', backgroundColor: '#0ABB4F'},{content: '#A2A4CD', backgroundColor: '#A2A4CD'},{content: '#45062C', backgroundColor: '#45062C'},
];
interface Styles {
