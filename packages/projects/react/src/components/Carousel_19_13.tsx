...
const slides: SlideData[] = [
   {content: '#C07CA1', backgroundColor: '#C07CA1'},{content: '#15ED3B', backgroundColor: '#15ED3B'},{content: '#6DD295', backgroundColor: '#6DD295'},
];
interface Styles {
