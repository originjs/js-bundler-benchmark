...
const slides: SlideData[] = [
   {content: '#242F1A', backgroundColor: '#242F1A'},{content: '#D00E32', backgroundColor: '#D00E32'},{content: '#3BA323', backgroundColor: '#3BA323'},
];
interface Styles {
