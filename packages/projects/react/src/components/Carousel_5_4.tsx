...
const slides: SlideData[] = [
   {content: '#3ECD66', backgroundColor: '#3ECD66'},{content: '#11ED95', backgroundColor: '#11ED95'},{content: '#9CB3E2', backgroundColor: '#9CB3E2'},
];
interface Styles {
