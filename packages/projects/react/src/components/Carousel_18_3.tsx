...
const slides: SlideData[] = [
   {content: '#A83318', backgroundColor: '#A83318'},{content: '#F48B7B', backgroundColor: '#F48B7B'},{content: '#8923F3', backgroundColor: '#8923F3'},
];
interface Styles {
