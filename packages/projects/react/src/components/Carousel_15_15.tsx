...
const slides: SlideData[] = [
   {content: '#1DE045', backgroundColor: '#1DE045'},{content: '#BF0128', backgroundColor: '#BF0128'},{content: '#74031C', backgroundColor: '#74031C'},
];
interface Styles {
