...
const slides: SlideData[] = [
   {content: '#83759D', backgroundColor: '#83759D'},{content: '#803D1A', backgroundColor: '#803D1A'},{content: '#93C7F4', backgroundColor: '#93C7F4'},
];
interface Styles {
