...
const slides: SlideData[] = [
   {content: '#82AA55', backgroundColor: '#82AA55'},{content: '#8DD5CB', backgroundColor: '#8DD5CB'},{content: '#AA3261', backgroundColor: '#AA3261'},
];
interface Styles {
