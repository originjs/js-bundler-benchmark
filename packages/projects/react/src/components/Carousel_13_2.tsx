...
const slides: SlideData[] = [
   {content: '#E2070F', backgroundColor: '#E2070F'},{content: '#3A89F8', backgroundColor: '#3A89F8'},{content: '#1F326B', backgroundColor: '#1F326B'},
];
interface Styles {
