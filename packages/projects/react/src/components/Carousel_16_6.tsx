...
const slides: SlideData[] = [
   {content: '#A69721', backgroundColor: '#A69721'},{content: '#9C5227', backgroundColor: '#9C5227'},{content: '#F77F82', backgroundColor: '#F77F82'},
];
interface Styles {
