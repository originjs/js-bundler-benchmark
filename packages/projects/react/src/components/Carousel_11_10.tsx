...
const slides: SlideData[] = [
   {content: '#903CC2', backgroundColor: '#903CC2'},{content: '#1FF0F5', backgroundColor: '#1FF0F5'},{content: '#1FAFB9', backgroundColor: '#1FAFB9'},
];
interface Styles {
