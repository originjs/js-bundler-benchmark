...
const slides: SlideData[] = [
   {content: '#E71035', backgroundColor: '#E71035'},{content: '#2AE48A', backgroundColor: '#2AE48A'},{content: '#DD02DE', backgroundColor: '#DD02DE'},
];
interface Styles {
