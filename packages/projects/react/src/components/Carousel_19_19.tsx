...
const slides: SlideData[] = [
   {content: '#6E662F', backgroundColor: '#6E662F'},{content: '#62DC3F', backgroundColor: '#62DC3F'},{content: '#B8447D', backgroundColor: '#B8447D'},
];
interface Styles {
