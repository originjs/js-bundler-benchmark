...
const slides: SlideData[] = [
   {content: '#BACAD1', backgroundColor: '#BACAD1'},{content: '#669F39', backgroundColor: '#669F39'},{content: '#753C88', backgroundColor: '#753C88'},
];
interface Styles {
