...
const slides: SlideData[] = [
   {content: '#60F728', backgroundColor: '#60F728'},{content: '#73C656', backgroundColor: '#73C656'},{content: '#D56212', backgroundColor: '#D56212'},
];
interface Styles {
