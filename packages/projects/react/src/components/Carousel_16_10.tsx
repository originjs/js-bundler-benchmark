...
const slides: SlideData[] = [
   {content: '#A79EDD', backgroundColor: '#A79EDD'},{content: '#4EBB6E', backgroundColor: '#4EBB6E'},{content: '#2E227F', backgroundColor: '#2E227F'},
];
interface Styles {
