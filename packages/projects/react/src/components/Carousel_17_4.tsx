...
const slides: SlideData[] = [
   {content: '#E795A9', backgroundColor: '#E795A9'},{content: '#F127C8', backgroundColor: '#F127C8'},{content: '#8DBC54', backgroundColor: '#8DBC54'},
];
interface Styles {
