...
const slides: SlideData[] = [
   {content: '#561F8F', backgroundColor: '#561F8F'},{content: '#6F497B', backgroundColor: '#6F497B'},{content: '#B3B234', backgroundColor: '#B3B234'},
];
interface Styles {
