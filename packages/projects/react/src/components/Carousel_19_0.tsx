...
const slides: SlideData[] = [
   {content: '#36AE4D', backgroundColor: '#36AE4D'},{content: '#236196', backgroundColor: '#236196'},{content: '#258ED0', backgroundColor: '#258ED0'},
];
interface Styles {
