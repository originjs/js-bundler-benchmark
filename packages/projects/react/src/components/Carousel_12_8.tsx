...
const slides: SlideData[] = [
   {content: '#C06D7F', backgroundColor: '#C06D7F'},{content: '#206453', backgroundColor: '#206453'},{content: '#F0E4D8', backgroundColor: '#F0E4D8'},
];
interface Styles {
