...
const slides: SlideData[] = [
   {content: '#604090', backgroundColor: '#604090'},{content: '#C37788', backgroundColor: '#C37788'},{content: '#26AB3A', backgroundColor: '#26AB3A'},
];
interface Styles {
