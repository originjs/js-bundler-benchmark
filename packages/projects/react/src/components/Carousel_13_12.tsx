...
const slides: SlideData[] = [
   {content: '#21DE74', backgroundColor: '#21DE74'},{content: '#380D2C', backgroundColor: '#380D2C'},{content: '#768F9A', backgroundColor: '#768F9A'},
];
interface Styles {
