...
const slides: SlideData[] = [
   {content: '#CB5075', backgroundColor: '#CB5075'},{content: '#AB19FD', backgroundColor: '#AB19FD'},{content: '#B4F2A8', backgroundColor: '#B4F2A8'},
];
interface Styles {
