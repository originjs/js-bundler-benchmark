...
const slides: SlideData[] = [
   {content: '#9ACA51', backgroundColor: '#9ACA51'},{content: '#DC51B1', backgroundColor: '#DC51B1'},{content: '#9B7AF3', backgroundColor: '#9B7AF3'},
];
interface Styles {
