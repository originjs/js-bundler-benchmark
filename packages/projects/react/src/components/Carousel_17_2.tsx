...
const slides: SlideData[] = [
   {content: '#68C984', backgroundColor: '#68C984'},{content: '#A3DD91', backgroundColor: '#A3DD91'},{content: '#418CBB', backgroundColor: '#418CBB'},
];
interface Styles {
