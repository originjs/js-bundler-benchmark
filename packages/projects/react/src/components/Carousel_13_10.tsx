...
const slides: SlideData[] = [
   {content: '#190081', backgroundColor: '#190081'},{content: '#0CC5BC', backgroundColor: '#0CC5BC'},{content: '#334517', backgroundColor: '#334517'},
];
interface Styles {
