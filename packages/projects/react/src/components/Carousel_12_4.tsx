...
const slides: SlideData[] = [
   {content: '#E896BF', backgroundColor: '#E896BF'},{content: '#935185', backgroundColor: '#935185'},{content: '#588C67', backgroundColor: '#588C67'},
];
interface Styles {
