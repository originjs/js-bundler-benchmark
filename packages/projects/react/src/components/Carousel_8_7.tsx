...
const slides: SlideData[] = [
   {content: '#FB2AF8', backgroundColor: '#FB2AF8'},{content: '#448AFD', backgroundColor: '#448AFD'},{content: '#68756B', backgroundColor: '#68756B'},
];
interface Styles {
