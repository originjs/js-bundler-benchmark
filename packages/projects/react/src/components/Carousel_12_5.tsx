...
const slides: SlideData[] = [
   {content: '#0B1000', backgroundColor: '#0B1000'},{content: '#9F7853', backgroundColor: '#9F7853'},{content: '#999CE1', backgroundColor: '#999CE1'},
];
interface Styles {
