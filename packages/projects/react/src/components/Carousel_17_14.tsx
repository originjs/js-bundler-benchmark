...
const slides: SlideData[] = [
   {content: '#7E4632', backgroundColor: '#7E4632'},{content: '#758DAF', backgroundColor: '#758DAF'},{content: '#40033C', backgroundColor: '#40033C'},
];
interface Styles {
