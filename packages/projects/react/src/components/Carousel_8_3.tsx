...
const slides: SlideData[] = [
   {content: '#15D5AA', backgroundColor: '#15D5AA'},{content: '#1405BA', backgroundColor: '#1405BA'},{content: '#5BEAA4', backgroundColor: '#5BEAA4'},
];
interface Styles {
