...
const slides: SlideData[] = [
   {content: '#72A7BA', backgroundColor: '#72A7BA'},{content: '#667245', backgroundColor: '#667245'},{content: '#F5CF67', backgroundColor: '#F5CF67'},
];
interface Styles {
