...
const slides: SlideData[] = [
   {content: '#DC9AFF', backgroundColor: '#DC9AFF'},{content: '#0AB904', backgroundColor: '#0AB904'},{content: '#C562D2', backgroundColor: '#C562D2'},
];
interface Styles {
