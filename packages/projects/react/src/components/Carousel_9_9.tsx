...
const slides: SlideData[] = [
   {content: '#30B599', backgroundColor: '#30B599'},{content: '#9FA4BA', backgroundColor: '#9FA4BA'},{content: '#FA8B80', backgroundColor: '#FA8B80'},
];
interface Styles {
