...
const slides: SlideData[] = [
   {content: '#BE6A47', backgroundColor: '#BE6A47'},{content: '#3E9428', backgroundColor: '#3E9428'},{content: '#500855', backgroundColor: '#500855'},
];
interface Styles {
