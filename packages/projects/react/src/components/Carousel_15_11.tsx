...
const slides: SlideData[] = [
   {content: '#440C65', backgroundColor: '#440C65'},{content: '#85B55E', backgroundColor: '#85B55E'},{content: '#E42785', backgroundColor: '#E42785'},
];
interface Styles {
