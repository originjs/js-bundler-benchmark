...
const slides: SlideData[] = [
   {content: '#18828B', backgroundColor: '#18828B'},{content: '#3844A4', backgroundColor: '#3844A4'},{content: '#811686', backgroundColor: '#811686'},
];
interface Styles {
