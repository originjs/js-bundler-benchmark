...
const slides: SlideData[] = [
   {content: '#2BF31B', backgroundColor: '#2BF31B'},{content: '#05E5C4', backgroundColor: '#05E5C4'},{content: '#30425F', backgroundColor: '#30425F'},
];
interface Styles {
