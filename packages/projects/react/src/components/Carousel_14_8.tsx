...
const slides: SlideData[] = [
   {content: '#5AE9B8', backgroundColor: '#5AE9B8'},{content: '#038C4B', backgroundColor: '#038C4B'},{content: '#9A1674', backgroundColor: '#9A1674'},
];
interface Styles {
