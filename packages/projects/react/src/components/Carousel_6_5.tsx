...
const slides: SlideData[] = [
   {content: '#690C61', backgroundColor: '#690C61'},{content: '#BEFCB6', backgroundColor: '#BEFCB6'},{content: '#753FD6', backgroundColor: '#753FD6'},
];
interface Styles {
