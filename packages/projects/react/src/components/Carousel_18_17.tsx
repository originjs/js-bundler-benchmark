...
const slides: SlideData[] = [
   {content: '#7E9951', backgroundColor: '#7E9951'},{content: '#068418', backgroundColor: '#068418'},{content: '#C526B3', backgroundColor: '#C526B3'},
];
interface Styles {
