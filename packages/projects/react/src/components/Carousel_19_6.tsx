...
const slides: SlideData[] = [
   {content: '#2C53E5', backgroundColor: '#2C53E5'},{content: '#29AB8A', backgroundColor: '#29AB8A'},{content: '#BD0FEF', backgroundColor: '#BD0FEF'},
];
interface Styles {
