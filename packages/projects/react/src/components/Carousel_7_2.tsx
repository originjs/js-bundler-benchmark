...
const slides: SlideData[] = [
   {content: '#F95A89', backgroundColor: '#F95A89'},{content: '#8AEE7C', backgroundColor: '#8AEE7C'},{content: '#955BAB', backgroundColor: '#955BAB'},
];
interface Styles {
