...
const slides: SlideData[] = [
   {content: '#EB787B', backgroundColor: '#EB787B'},{content: '#FE252B', backgroundColor: '#FE252B'},{content: '#E02621', backgroundColor: '#E02621'},
];
interface Styles {
