...
const slides: SlideData[] = [
   {content: '#DCA1B0', backgroundColor: '#DCA1B0'},{content: '#73F853', backgroundColor: '#73F853'},{content: '#EB84F7', backgroundColor: '#EB84F7'},
];
interface Styles {
