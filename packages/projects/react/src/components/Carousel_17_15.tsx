...
const slides: SlideData[] = [
   {content: '#EDDE83', backgroundColor: '#EDDE83'},{content: '#6C65A1', backgroundColor: '#6C65A1'},{content: '#1AF44B', backgroundColor: '#1AF44B'},
];
interface Styles {
