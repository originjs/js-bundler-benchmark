...
const slides: SlideData[] = [
   {content: '#EAB348', backgroundColor: '#EAB348'},{content: '#61F2AD', backgroundColor: '#61F2AD'},{content: '#4E4F94', backgroundColor: '#4E4F94'},
];
interface Styles {
