...
const slides: SlideData[] = [
   {content: '#0529AA', backgroundColor: '#0529AA'},{content: '#A10B1B', backgroundColor: '#A10B1B'},{content: '#CAB3DE', backgroundColor: '#CAB3DE'},
];
interface Styles {
