...
const slides: SlideData[] = [
   {content: '#5C8079', backgroundColor: '#5C8079'},{content: '#C70330', backgroundColor: '#C70330'},{content: '#9607F2', backgroundColor: '#9607F2'},
];
interface Styles {
