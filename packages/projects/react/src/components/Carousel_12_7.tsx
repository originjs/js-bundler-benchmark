...
const slides: SlideData[] = [
   {content: '#1452F6', backgroundColor: '#1452F6'},{content: '#0C0F2C', backgroundColor: '#0C0F2C'},{content: '#CB0669', backgroundColor: '#CB0669'},
];
interface Styles {
