...
const slides: SlideData[] = [
   {content: '#74ABBD', backgroundColor: '#74ABBD'},{content: '#747CC7', backgroundColor: '#747CC7'},{content: '#60A674', backgroundColor: '#60A674'},
];
interface Styles {
