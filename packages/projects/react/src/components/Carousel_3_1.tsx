...
const slides: SlideData[] = [
   {content: '#93D951', backgroundColor: '#93D951'},{content: '#B22D1F', backgroundColor: '#B22D1F'},{content: '#029E10', backgroundColor: '#029E10'},
];
interface Styles {
