...
const slides: SlideData[] = [
   {content: '#7C508C', backgroundColor: '#7C508C'},{content: '#A1186E', backgroundColor: '#A1186E'},{content: '#6381CF', backgroundColor: '#6381CF'},
];
interface Styles {
