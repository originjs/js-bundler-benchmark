...
const slides: SlideData[] = [
   {content: '#5A278F', backgroundColor: '#5A278F'},{content: '#5888FF', backgroundColor: '#5888FF'},{content: '#F60DC3', backgroundColor: '#F60DC3'},
];
interface Styles {
