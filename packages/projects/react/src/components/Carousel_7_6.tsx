...
const slides: SlideData[] = [
   {content: '#8428C3', backgroundColor: '#8428C3'},{content: '#0D4277', backgroundColor: '#0D4277'},{content: '#2D3B32', backgroundColor: '#2D3B32'},
];
interface Styles {
