...
const slides: SlideData[] = [
   {content: '#107DAC', backgroundColor: '#107DAC'},{content: '#CA679D', backgroundColor: '#CA679D'},{content: '#26E646', backgroundColor: '#26E646'},
];
interface Styles {
