...
const slides: SlideData[] = [
   {content: '#8FBF41', backgroundColor: '#8FBF41'},{content: '#075C84', backgroundColor: '#075C84'},{content: '#C7BC22', backgroundColor: '#C7BC22'},
];
interface Styles {
