...
const slides: SlideData[] = [
   {content: '#32DDCC', backgroundColor: '#32DDCC'},{content: '#C73FA3', backgroundColor: '#C73FA3'},{content: '#36349E', backgroundColor: '#36349E'},
];
interface Styles {
