...
const slides: SlideData[] = [
   {content: '#5C8670', backgroundColor: '#5C8670'},{content: '#873A18', backgroundColor: '#873A18'},{content: '#7B3F34', backgroundColor: '#7B3F34'},
];
interface Styles {
