...
const slides: SlideData[] = [
   {content: '#D47CBA', backgroundColor: '#D47CBA'},{content: '#A5765B', backgroundColor: '#A5765B'},{content: '#FD0CA1', backgroundColor: '#FD0CA1'},
];
interface Styles {
