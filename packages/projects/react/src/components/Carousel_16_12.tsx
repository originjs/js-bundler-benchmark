...
const slides: SlideData[] = [
   {content: '#04AF53', backgroundColor: '#04AF53'},{content: '#686788', backgroundColor: '#686788'},{content: '#CB5A63', backgroundColor: '#CB5A63'},
];
interface Styles {
