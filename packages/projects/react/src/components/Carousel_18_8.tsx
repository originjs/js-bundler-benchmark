...
const slides: SlideData[] = [
   {content: '#1F6084', backgroundColor: '#1F6084'},{content: '#F1917F', backgroundColor: '#F1917F'},{content: '#FF38F2', backgroundColor: '#FF38F2'},
];
interface Styles {
