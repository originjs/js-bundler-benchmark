...
const slides: SlideData[] = [
   {content: '#23FBF5', backgroundColor: '#23FBF5'},{content: '#9FAD9A', backgroundColor: '#9FAD9A'},{content: '#F5C0B9', backgroundColor: '#F5C0B9'},
];
interface Styles {
