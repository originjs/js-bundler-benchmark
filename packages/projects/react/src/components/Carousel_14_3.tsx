...
const slides: SlideData[] = [
   {content: '#7B04CE', backgroundColor: '#7B04CE'},{content: '#1E770A', backgroundColor: '#1E770A'},{content: '#1542A7', backgroundColor: '#1542A7'},
];
interface Styles {
