...
const slides: SlideData[] = [
   {content: '#C51C48', backgroundColor: '#C51C48'},{content: '#FFFE30', backgroundColor: '#FFFE30'},{content: '#801281', backgroundColor: '#801281'},
];
interface Styles {
