...
const slides: SlideData[] = [
   {content: '#54D877', backgroundColor: '#54D877'},{content: '#2F8A6C', backgroundColor: '#2F8A6C'},{content: '#384AC6', backgroundColor: '#384AC6'},
];
interface Styles {
