...
const slides: SlideData[] = [
   {content: '#1C0119', backgroundColor: '#1C0119'},{content: '#E3F432', backgroundColor: '#E3F432'},{content: '#0CBC42', backgroundColor: '#0CBC42'},
];
interface Styles {
