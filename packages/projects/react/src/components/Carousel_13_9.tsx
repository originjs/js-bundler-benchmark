...
const slides: SlideData[] = [
   {content: '#654ECE', backgroundColor: '#654ECE'},{content: '#1D9F62', backgroundColor: '#1D9F62'},{content: '#D242B3', backgroundColor: '#D242B3'},
];
interface Styles {
