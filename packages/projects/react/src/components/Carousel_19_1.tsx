...
const slides: SlideData[] = [
   {content: '#5BF800', backgroundColor: '#5BF800'},{content: '#35A20B', backgroundColor: '#35A20B'},{content: '#2785FA', backgroundColor: '#2785FA'},
];
interface Styles {
