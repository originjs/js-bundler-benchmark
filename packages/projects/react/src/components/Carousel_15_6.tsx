...
const slides: SlideData[] = [
   {content: '#0B9C82', backgroundColor: '#0B9C82'},{content: '#64E911', backgroundColor: '#64E911'},{content: '#5022FD', backgroundColor: '#5022FD'},
];
interface Styles {
