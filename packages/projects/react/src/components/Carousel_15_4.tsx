...
const slides: SlideData[] = [
   {content: '#723D32', backgroundColor: '#723D32'},{content: '#232570', backgroundColor: '#232570'},{content: '#B9E4C2', backgroundColor: '#B9E4C2'},
];
interface Styles {
