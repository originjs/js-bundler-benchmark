...
const slides: SlideData[] = [
   {content: '#C36A55', backgroundColor: '#C36A55'},{content: '#23964E', backgroundColor: '#23964E'},{content: '#00513D', backgroundColor: '#00513D'},
];
interface Styles {
