...
const slides: SlideData[] = [
   {content: '#FA765E', backgroundColor: '#FA765E'},{content: '#4F306F', backgroundColor: '#4F306F'},{content: '#9FFF02', backgroundColor: '#9FFF02'},
];
interface Styles {
