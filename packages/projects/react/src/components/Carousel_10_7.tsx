...
const slides: SlideData[] = [
   {content: '#421A46', backgroundColor: '#421A46'},{content: '#C57C3B', backgroundColor: '#C57C3B'},{content: '#28DF0E', backgroundColor: '#28DF0E'},
];
interface Styles {
