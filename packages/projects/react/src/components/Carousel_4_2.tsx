...
const slides: SlideData[] = [
   {content: '#D14FF6', backgroundColor: '#D14FF6'},{content: '#0237AA', backgroundColor: '#0237AA'},{content: '#EFE7EB', backgroundColor: '#EFE7EB'},
];
interface Styles {
