...
const slides: SlideData[] = [
   {content: '#1CDCF9', backgroundColor: '#1CDCF9'},{content: '#ECCEC6', backgroundColor: '#ECCEC6'},{content: '#88D912', backgroundColor: '#88D912'},
];
interface Styles {
