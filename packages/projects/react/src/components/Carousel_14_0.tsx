...
const slides: SlideData[] = [
   {content: '#D31D17', backgroundColor: '#D31D17'},{content: '#55128A', backgroundColor: '#55128A'},{content: '#AACA5D', backgroundColor: '#AACA5D'},
];
interface Styles {
