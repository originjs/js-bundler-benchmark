...
const slides: SlideData[] = [
   {content: '#68F46C', backgroundColor: '#68F46C'},{content: '#8B91FA', backgroundColor: '#8B91FA'},{content: '#FF871C', backgroundColor: '#FF871C'},
];
interface Styles {
