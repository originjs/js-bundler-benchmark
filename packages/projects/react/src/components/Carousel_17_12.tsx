...
const slides: SlideData[] = [
   {content: '#09C894', backgroundColor: '#09C894'},{content: '#2C259B', backgroundColor: '#2C259B'},{content: '#FAEA4A', backgroundColor: '#FAEA4A'},
];
interface Styles {
