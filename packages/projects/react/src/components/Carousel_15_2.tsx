...
const slides: SlideData[] = [
   {content: '#77433C', backgroundColor: '#77433C'},{content: '#B8D4E0', backgroundColor: '#B8D4E0'},{content: '#F2D139', backgroundColor: '#F2D139'},
];
interface Styles {
