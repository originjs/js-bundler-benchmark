...
const slides: SlideData[] = [
   {content: '#C99EFF', backgroundColor: '#C99EFF'},{content: '#B440BF', backgroundColor: '#B440BF'},{content: '#E5F9A6', backgroundColor: '#E5F9A6'},
];
interface Styles {
