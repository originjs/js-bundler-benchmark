...
const slides: SlideData[] = [
   {content: '#F6E81B', backgroundColor: '#F6E81B'},{content: '#9F61F2', backgroundColor: '#9F61F2'},{content: '#C93242', backgroundColor: '#C93242'},
];
interface Styles {
