...
const slides: SlideData[] = [
   {content: '#46DFCD', backgroundColor: '#46DFCD'},{content: '#E4AA47', backgroundColor: '#E4AA47'},{content: '#62FDA9', backgroundColor: '#62FDA9'},
];
interface Styles {
