...
const slides: SlideData[] = [
   {content: '#818FDD', backgroundColor: '#818FDD'},{content: '#791455', backgroundColor: '#791455'},{content: '#4B79A9', backgroundColor: '#4B79A9'},
];
interface Styles {
