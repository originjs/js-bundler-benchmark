...
const slides: SlideData[] = [
   {content: '#5BD034', backgroundColor: '#5BD034'},{content: '#6D5D81', backgroundColor: '#6D5D81'},{content: '#A61432', backgroundColor: '#A61432'},
];
interface Styles {
