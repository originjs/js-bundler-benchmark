...
const slides: SlideData[] = [
   {content: '#5D32AF', backgroundColor: '#5D32AF'},{content: '#E6BB40', backgroundColor: '#E6BB40'},{content: '#B00E28', backgroundColor: '#B00E28'},
];
interface Styles {
