...
const slides: SlideData[] = [
   {content: '#07B8B8', backgroundColor: '#07B8B8'},{content: '#E755FA', backgroundColor: '#E755FA'},{content: '#16ADE5', backgroundColor: '#16ADE5'},
];
interface Styles {
