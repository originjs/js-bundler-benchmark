...
const slides: SlideData[] = [
   {content: '#C0A501', backgroundColor: '#C0A501'},{content: '#DB7247', backgroundColor: '#DB7247'},{content: '#EAAEB3', backgroundColor: '#EAAEB3'},
];
interface Styles {
