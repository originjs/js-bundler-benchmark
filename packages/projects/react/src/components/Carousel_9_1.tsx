...
const slides: SlideData[] = [
   {content: '#D22BC6', backgroundColor: '#D22BC6'},{content: '#AE12C1', backgroundColor: '#AE12C1'},{content: '#2B384B', backgroundColor: '#2B384B'},
];
interface Styles {
