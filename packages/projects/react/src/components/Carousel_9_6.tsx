...
const slides: SlideData[] = [
   {content: '#D3DCF4', backgroundColor: '#D3DCF4'},{content: '#111028', backgroundColor: '#111028'},{content: '#EEE503', backgroundColor: '#EEE503'},
];
interface Styles {
