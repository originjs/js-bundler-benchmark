...
const slides: SlideData[] = [
   {content: '#BD2FC5', backgroundColor: '#BD2FC5'},{content: '#985A01', backgroundColor: '#985A01'},{content: '#8EFAA2', backgroundColor: '#8EFAA2'},
];
interface Styles {
