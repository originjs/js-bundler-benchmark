...
const slides: SlideData[] = [
   {content: '#34A698', backgroundColor: '#34A698'},{content: '#41DE83', backgroundColor: '#41DE83'},{content: '#A42733', backgroundColor: '#A42733'},
];
interface Styles {
