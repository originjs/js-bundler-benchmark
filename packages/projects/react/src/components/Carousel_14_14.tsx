...
const slides: SlideData[] = [
   {content: '#6D4E97', backgroundColor: '#6D4E97'},{content: '#1CA3D4', backgroundColor: '#1CA3D4'},{content: '#D28A38', backgroundColor: '#D28A38'},
];
interface Styles {
