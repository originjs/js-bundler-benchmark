...
const slides: SlideData[] = [
   {content: '#67FCE5', backgroundColor: '#67FCE5'},{content: '#2B38AC', backgroundColor: '#2B38AC'},{content: '#E71DB8', backgroundColor: '#E71DB8'},
];
interface Styles {
