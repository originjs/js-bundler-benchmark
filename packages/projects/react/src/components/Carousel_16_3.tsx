...
const slides: SlideData[] = [
   {content: '#C1BA7E', backgroundColor: '#C1BA7E'},{content: '#9EDA8A', backgroundColor: '#9EDA8A'},{content: '#3BF034', backgroundColor: '#3BF034'},
];
interface Styles {
