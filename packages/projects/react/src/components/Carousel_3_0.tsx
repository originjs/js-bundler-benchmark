...
const slides: SlideData[] = [
   {content: '#5622FF', backgroundColor: '#5622FF'},{content: '#E8BD78', backgroundColor: '#E8BD78'},{content: '#669486', backgroundColor: '#669486'},
];
interface Styles {
