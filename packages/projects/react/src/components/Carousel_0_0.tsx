...
const slides: SlideData[] = [
   {content: '#5C1B2F', backgroundColor: '#5C1B2F'},{content: '#6AAF3C', backgroundColor: '#6AAF3C'},{content: '#F4E41B', backgroundColor: '#F4E41B'},
];
interface Styles {
