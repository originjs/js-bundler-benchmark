...
const slides: SlideData[] = [
   {content: '#94F6FD', backgroundColor: '#94F6FD'},{content: '#4CD717', backgroundColor: '#4CD717'},{content: '#A3E7BE', backgroundColor: '#A3E7BE'},
];
interface Styles {
