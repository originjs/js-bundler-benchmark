...
const slides: SlideData[] = [
    {content: '#2D8A59', backgroundColor: '#2D8A59'}, {
        content: '#FC611B',
        backgroundColor: '#FC611B'
    }, {content: '#AF8FBE', backgroundColor: '#AF8FBE'},
];
