...
const slides: SlideData[] = [
   {content: '#FB4F89', backgroundColor: '#FB4F89'},{content: '#4B08A9', backgroundColor: '#4B08A9'},{content: '#B1260E', backgroundColor: '#B1260E'},
];
interface Styles {
