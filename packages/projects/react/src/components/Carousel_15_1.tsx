...
const slides: SlideData[] = [
   {content: '#8BECD3', backgroundColor: '#8BECD3'},{content: '#5D725F', backgroundColor: '#5D725F'},{content: '#1E463B', backgroundColor: '#1E463B'},
];
interface Styles {
