...
const slides: SlideData[] = [
   {content: '#687DCA', backgroundColor: '#687DCA'},{content: '#7816B4', backgroundColor: '#7816B4'},{content: '#B8430E', backgroundColor: '#B8430E'},
];
interface Styles {
