...
const slides: SlideData[] = [
   {content: '#A42A22', backgroundColor: '#A42A22'},{content: '#777629', backgroundColor: '#777629'},{content: '#E67EC7', backgroundColor: '#E67EC7'},
];
interface Styles {
