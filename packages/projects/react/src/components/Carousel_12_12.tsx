...
const slides: SlideData[] = [
   {content: '#6DC803', backgroundColor: '#6DC803'},{content: '#4774E8', backgroundColor: '#4774E8'},{content: '#B3A0D6', backgroundColor: '#B3A0D6'},
];
interface Styles {
