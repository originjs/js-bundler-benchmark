...
const slides: SlideData[] = [
   {content: '#A54C3A', backgroundColor: '#A54C3A'},{content: '#4CEC12', backgroundColor: '#4CEC12'},{content: '#7E36C5', backgroundColor: '#7E36C5'},
];
interface Styles {
