...
const slides: SlideData[] = [
   {content: '#0E6B28', backgroundColor: '#0E6B28'},{content: '#F0BDB9', backgroundColor: '#F0BDB9'},{content: '#E60EA9', backgroundColor: '#E60EA9'},
];
interface Styles {
