...
const slides: SlideData[] = [
   {content: '#71F425', backgroundColor: '#71F425'},{content: '#D827D5', backgroundColor: '#D827D5'},{content: '#4D099C', backgroundColor: '#4D099C'},
];
interface Styles {
