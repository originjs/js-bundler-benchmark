...
const slides: SlideData[] = [
   {content: '#FA5009', backgroundColor: '#FA5009'},{content: '#AB941B', backgroundColor: '#AB941B'},{content: '#8E62C1', backgroundColor: '#8E62C1'},
];
interface Styles {
