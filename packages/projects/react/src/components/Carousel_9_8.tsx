...
const slides: SlideData[] = [
   {content: '#EDF3A5', backgroundColor: '#EDF3A5'},{content: '#39C37D', backgroundColor: '#39C37D'},{content: '#3280B5', backgroundColor: '#3280B5'},
];
interface Styles {
