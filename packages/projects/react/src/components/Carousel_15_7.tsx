...
const slides: SlideData[] = [
   {content: '#C87BD7', backgroundColor: '#C87BD7'},{content: '#97E31E', backgroundColor: '#97E31E'},{content: '#753DC8', backgroundColor: '#753DC8'},
];
interface Styles {
