...
const slides: SlideData[] = [
   {content: '#15CC1A', backgroundColor: '#15CC1A'},{content: '#C5B580', backgroundColor: '#C5B580'},{content: '#EE2307', backgroundColor: '#EE2307'},
];
interface Styles {
