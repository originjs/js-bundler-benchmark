...
const slides: SlideData[] = [
   {content: '#7284E8', backgroundColor: '#7284E8'},{content: '#13F4B7', backgroundColor: '#13F4B7'},{content: '#734960', backgroundColor: '#734960'},
];
interface Styles {
