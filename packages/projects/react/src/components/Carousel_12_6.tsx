...
const slides: SlideData[] = [
   {content: '#148F26', backgroundColor: '#148F26'},{content: '#6DAE52', backgroundColor: '#6DAE52'},{content: '#D771C6', backgroundColor: '#D771C6'},
];
interface Styles {
