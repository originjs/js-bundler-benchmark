...
const slides: SlideData[] = [
   {content: '#9F9BBD', backgroundColor: '#9F9BBD'},{content: '#225A85', backgroundColor: '#225A85'},{content: '#EE2A56', backgroundColor: '#EE2A56'},
];
interface Styles {
