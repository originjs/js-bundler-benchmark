...
const slides: SlideData[] = [
   {content: '#368149', backgroundColor: '#368149'},{content: '#9CC3D3', backgroundColor: '#9CC3D3'},{content: '#52CDBE', backgroundColor: '#52CDBE'},
];
interface Styles {
