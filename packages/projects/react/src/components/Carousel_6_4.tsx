...
const slides: SlideData[] = [
   {content: '#4A8EE6', backgroundColor: '#4A8EE6'},{content: '#8E66F4', backgroundColor: '#8E66F4'},{content: '#E966AA', backgroundColor: '#E966AA'},
];
interface Styles {
