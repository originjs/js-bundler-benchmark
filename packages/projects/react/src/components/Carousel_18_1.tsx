...
const slides: SlideData[] = [
   {content: '#FB4569', backgroundColor: '#FB4569'},{content: '#997B47', backgroundColor: '#997B47'},{content: '#D87D59', backgroundColor: '#D87D59'},
];
interface Styles {
