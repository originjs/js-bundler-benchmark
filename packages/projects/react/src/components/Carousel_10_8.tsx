...
const slides: SlideData[] = [
   {content: '#C2C79C', backgroundColor: '#C2C79C'},{content: '#D50A3F', backgroundColor: '#D50A3F'},{content: '#249587', backgroundColor: '#249587'},
];
interface Styles {
