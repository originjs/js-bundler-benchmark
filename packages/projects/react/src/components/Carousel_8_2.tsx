...
const slides: SlideData[] = [
   {content: '#D8378B', backgroundColor: '#D8378B'},{content: '#F829D6', backgroundColor: '#F829D6'},{content: '#1F6D06', backgroundColor: '#1F6D06'},
];
interface Styles {
