...
const slides: SlideData[] = [
   {content: '#47C7B2', backgroundColor: '#47C7B2'},{content: '#63ECBD', backgroundColor: '#63ECBD'},{content: '#D0AC30', backgroundColor: '#D0AC30'},
];
interface Styles {
