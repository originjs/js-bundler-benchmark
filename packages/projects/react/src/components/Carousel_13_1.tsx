...
const slides: SlideData[] = [
   {content: '#350353', backgroundColor: '#350353'},{content: '#7D0E9D', backgroundColor: '#7D0E9D'},{content: '#EA079E', backgroundColor: '#EA079E'},
];
interface Styles {
