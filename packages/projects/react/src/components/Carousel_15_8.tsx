...
const slides: SlideData[] = [
   {content: '#81D3BA', backgroundColor: '#81D3BA'},{content: '#6B80A2', backgroundColor: '#6B80A2'},{content: '#F3FA1F', backgroundColor: '#F3FA1F'},
];
interface Styles {
