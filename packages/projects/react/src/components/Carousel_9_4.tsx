...
const slides: SlideData[] = [
   {content: '#43A30D', backgroundColor: '#43A30D'},{content: '#AB9F44', backgroundColor: '#AB9F44'},{content: '#202B53', backgroundColor: '#202B53'},
];
interface Styles {
