...
const slides: SlideData[] = [
   {content: '#5AF8F8', backgroundColor: '#5AF8F8'},{content: '#F35043', backgroundColor: '#F35043'},{content: '#EC44F9', backgroundColor: '#EC44F9'},
];
interface Styles {
