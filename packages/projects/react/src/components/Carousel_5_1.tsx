...
const slides: SlideData[] = [
   {content: '#38FABE', backgroundColor: '#38FABE'},{content: '#95A9D4', backgroundColor: '#95A9D4'},{content: '#0394DF', backgroundColor: '#0394DF'},
];
interface Styles {
