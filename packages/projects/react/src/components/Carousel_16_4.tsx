...
const slides: SlideData[] = [
   {content: '#E713E6', backgroundColor: '#E713E6'},{content: '#DD8C0E', backgroundColor: '#DD8C0E'},{content: '#82FD8C', backgroundColor: '#82FD8C'},
];
interface Styles {
