...
const slides: SlideData[] = [
   {content: '#99A8AF', backgroundColor: '#99A8AF'},{content: '#0AE46B', backgroundColor: '#0AE46B'},{content: '#031775', backgroundColor: '#031775'},
];
interface Styles {
