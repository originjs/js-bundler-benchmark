...
const slides: SlideData[] = [
   {content: '#7B733F', backgroundColor: '#7B733F'},{content: '#80B6E4', backgroundColor: '#80B6E4'},{content: '#CE8BE4', backgroundColor: '#CE8BE4'},
];
interface Styles {
