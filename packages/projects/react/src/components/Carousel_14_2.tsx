...
const slides: SlideData[] = [
   {content: '#DF9B17', backgroundColor: '#DF9B17'},{content: '#91DB71', backgroundColor: '#91DB71'},{content: '#AA73A2', backgroundColor: '#AA73A2'},
];
interface Styles {
