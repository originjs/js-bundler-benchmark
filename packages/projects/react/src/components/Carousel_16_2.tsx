...
const slides: SlideData[] = [
   {content: '#0DB3DA', backgroundColor: '#0DB3DA'},{content: '#FC212D', backgroundColor: '#FC212D'},{content: '#DFC787', backgroundColor: '#DFC787'},
];
interface Styles {
