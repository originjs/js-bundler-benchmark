...
const slides: SlideData[] = [
   {content: '#A95A86', backgroundColor: '#A95A86'},{content: '#D8DC9E', backgroundColor: '#D8DC9E'},{content: '#21073C', backgroundColor: '#21073C'},
];
interface Styles {
