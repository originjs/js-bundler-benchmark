...
const slides: SlideData[] = [
   {content: '#1309EB', backgroundColor: '#1309EB'},{content: '#A770AE', backgroundColor: '#A770AE'},{content: '#BED9CD', backgroundColor: '#BED9CD'},
];
interface Styles {
