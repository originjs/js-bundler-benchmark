...
const slides: SlideData[] = [
   {content: '#A9D70D', backgroundColor: '#A9D70D'},{content: '#D18EE3', backgroundColor: '#D18EE3'},{content: '#2E2F58', backgroundColor: '#2E2F58'},
];
interface Styles {
