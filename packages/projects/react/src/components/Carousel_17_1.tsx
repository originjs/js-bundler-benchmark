...
const slides: SlideData[] = [
   {content: '#00F3A9', backgroundColor: '#00F3A9'},{content: '#E54DA9', backgroundColor: '#E54DA9'},{content: '#EA4847', backgroundColor: '#EA4847'},
];
interface Styles {
