...
const slides: SlideData[] = [
   {content: '#61B077', backgroundColor: '#61B077'},{content: '#4099A7', backgroundColor: '#4099A7'},{content: '#92F58E', backgroundColor: '#92F58E'},
];
interface Styles {
