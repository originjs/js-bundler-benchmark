...
const slides: SlideData[] = [
   {content: '#BA9B21', backgroundColor: '#BA9B21'},{content: '#379DB6', backgroundColor: '#379DB6'},{content: '#C62BC6', backgroundColor: '#C62BC6'},
];
interface Styles {
