...
const slides: SlideData[] = [
   {content: '#5EACF3', backgroundColor: '#5EACF3'},{content: '#D70003', backgroundColor: '#D70003'},{content: '#33E867', backgroundColor: '#33E867'},
];
interface Styles {
