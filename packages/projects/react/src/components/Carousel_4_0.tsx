...
const slides: SlideData[] = [
   {content: '#6A929B', backgroundColor: '#6A929B'},{content: '#1A912A', backgroundColor: '#1A912A'},{content: '#D18394', backgroundColor: '#D18394'},
];
interface Styles {
