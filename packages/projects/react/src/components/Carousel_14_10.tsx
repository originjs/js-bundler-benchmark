...
const slides: SlideData[] = [
   {content: '#9C21A4', backgroundColor: '#9C21A4'},{content: '#552D39', backgroundColor: '#552D39'},{content: '#B77E00', backgroundColor: '#B77E00'},
];
interface Styles {
