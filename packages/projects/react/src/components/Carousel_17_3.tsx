...
const slides: SlideData[] = [
   {content: '#57CF13', backgroundColor: '#57CF13'},{content: '#E6A035', backgroundColor: '#E6A035'},{content: '#86DC51', backgroundColor: '#86DC51'},
];
interface Styles {
