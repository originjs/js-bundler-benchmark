...
const slides: SlideData[] = [
   {content: '#152CF3', backgroundColor: '#152CF3'},{content: '#5F0BE4', backgroundColor: '#5F0BE4'},{content: '#4A34EE', backgroundColor: '#4A34EE'},
];
interface Styles {
