...
const slides: SlideData[] = [
   {content: '#46895E', backgroundColor: '#46895E'},{content: '#2FB7FC', backgroundColor: '#2FB7FC'},{content: '#F71FB4', backgroundColor: '#F71FB4'},
];
interface Styles {
