...
const slides: SlideData[] = [
   {content: '#DB5AD7', backgroundColor: '#DB5AD7'},{content: '#0240C0', backgroundColor: '#0240C0'},{content: '#72F2F5', backgroundColor: '#72F2F5'},
];
interface Styles {
