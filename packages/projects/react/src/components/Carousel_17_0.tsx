...
const slides: SlideData[] = [
   {content: '#F4BB9C', backgroundColor: '#F4BB9C'},{content: '#2EFB2A', backgroundColor: '#2EFB2A'},{content: '#202AC7', backgroundColor: '#202AC7'},
];
interface Styles {
