...
const slides: SlideData[] = [
   {content: '#6BF5D8', backgroundColor: '#6BF5D8'},{content: '#714318', backgroundColor: '#714318'},{content: '#472172', backgroundColor: '#472172'},
];
interface Styles {
