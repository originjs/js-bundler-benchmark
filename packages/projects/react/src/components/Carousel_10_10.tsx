...
const slides: SlideData[] = [
   {content: '#0FC476', backgroundColor: '#0FC476'},{content: '#EFBD1D', backgroundColor: '#EFBD1D'},{content: '#D1AC3B', backgroundColor: '#D1AC3B'},
];
interface Styles {
