...
const slides: SlideData[] = [
   {content: '#C80BFC', backgroundColor: '#C80BFC'},{content: '#CD2A32', backgroundColor: '#CD2A32'},{content: '#E3AEA4', backgroundColor: '#E3AEA4'},
];
interface Styles {
